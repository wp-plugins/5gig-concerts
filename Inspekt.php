 ...
 * Inspekt_Error
 */
require_once(URL_ROOT . 'class/Inspekt/Error.php');

/**
 * Inspekt_Cage
 */
require_once(URL_ROOT . 'class/Inspekt/Cage.php');

/**
 * Inspekt_Cage_Session
 */
require_once(URL_ROOT . 'class/Inspekt/Cage/Session.php');

/**
 * Inspekt_Supercage
 */
require_once(URL_ROOT . 'class/Inspekt/Supercage.php');
...
class Inspekt
{
	 ...
	 * @return Inspekt_Cage
	 */
	static function makeServerCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	 ...
	 * @static
	 */
	static function makeGetCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	 ...
	 * @static
	 */
	static function makePostCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	...
	/**
	 * Returns the $_REQUEST data wrapped in an Inspekt_Cage object
	 *
	 * This utilizes a singleton pattern to get around scoping issues
	 *
	 * @param string  $config_file
	 ...
	 * @static
	 */
	static function makeRequestCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
		...
		if (!isset($_instance)) {
			$_instance = Inspekt_Cage::Factory($_REQUEST, $config_file, '_REQUEST', $strict);
		}
	 ...
	 * @static
	 */
	static function makeCookieCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	 ...
	 * @static
	 */
	static function makeEnvCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	 ...
	 * @static
	 */
	static function makeFilesCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_instance;
	 ...
	 * @static
	 */
	static function makeSessionCage($config_file=NULL, $strict=TRUE) {
	 ...
	 * @static
	 */
	static function makeSuperCage($config_file=NULL, $strict=TRUE) {
		/**
		 * @staticvar $_instance
		 */
		static $_scinstance;
	...
	static function getAlnum($value)
	{
		if (is_array($value)) {
			...
			return preg_replace('/[^[:alnum:]_]/', '', $value);
		}
	}
...
//				$regex .= '$&i';
     ...
     * @static
     */
	static function noTags($value, $allowable_tags='')
	{
		if (is_array($value)) {
	...
	{
		if (is_array($value)) {
			return Inspekt::_walkArray($value, 'slash');
		} else {
			return addslashes($value);
		}
	}
	
	static function getHtml($value)
	{
		if (is_array($value)) {
			return Inspekt::_walkArray($value, 'getHtml');
		} else {
